    ...
    return LaunchDescription([
        Node(
            ...
            arguments=[
                ...
                '/world/car_world/model/vehicle_blue/link/chassis/sensor/front_cam/image@sensor_msgs/msg/Image@ignition.msgs.Image',
                '/world/car_world/model/vehicle_blue/link/chassis/sensor/front_cam/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo',
